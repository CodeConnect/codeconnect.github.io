...
**[Edit]:** In the comments Martin pointed out that it's because of the internal call to `JitHelpers.GetPinningHelper(Object)`. This method accepts `object`, so our `enum` is boxed here. Thanks Martin! :)
